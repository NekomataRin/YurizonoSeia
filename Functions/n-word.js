...
const nwordPatterns = [
    /(?:n(?:[*_\-]|[*-_])*([i1l!][*_\-]*)*[g96qɢԌ](?:[*_\-]*[ae3@4αаåâá])+(?:[*_\-]*[rs])?)|(?:n(?:[*_\-]|[*-_])*([e3@4αаåâá][*_\-]*)*[g96qɢԌ](?:[*_\-]*[ae3@4αаåâá])+(?:[*_\-]*[rs])?)/iu, // "n*gga", "n*egga", "ni*ga", "ne*gga", etc.
    /n(?:[*_\-]|[*-_])*[i1l!][*_\-]*[g96qɢԌ][*_\-]*[-–—]/iu,
    /n(?:[*_\-]|[*-_])+[i1l!]+[*_\-]+[g96qɢԌ]+/iu,
    /n(?:[*_\-]|[*-_])*[e3@4αаåâá][*_\-]*[g96qɢԌ][*_\-]*[a3@4αаåâá](?:[*_\-]*[rs])?/iu,
    /n(?:[*_\-]|[*-_])*[i1l!][*_\-]*[cс][*_\-]*[hɦ][*_\-]*[g96qɢԌ][*_\-]*[a3@4αаåâá]/iu,
    /n(?:[*_\-]|[*-_])*[e3@4αаåâá][*_\-]*[g96qɢԌ][*_\-]*[a3@4αаåâá]/iu,
    /n(?:[*_\-]|[*-_])*[i1l!][*_\-]*[b6][*_\-]*[b6][*_\-]*[a3@4αаåâá]/iu,
    /n(?:[*_\-]|[*-_])*([i1l!][*_\-]*)+[e3@4αаåâá]?r[*_\-]*[bcdfgjklmnpqrstvwxyz]/iu,
    /n(?:[*_\-]|[*-_])+[i1l!][*_\-]*[g96qɢԌ]?[e3@4αаåâá][*_\-]*r[*_\-]*[bcdfgjklmnpqrstvwxyz]\b/iu,
    /n(?:[*_\-]|[*-_])*[i1l!][*_\-]*[cс][*_\-]*[hɦ][*_\-]*[goóòôõōŏőơọỏõốồỗổộớờỡởợ]/iu,
    /n(?:[*_\-]|[*-_])*[i1l!][*_\-]*[g96qɢԌ]?[ae3@4αаåâá][*_\-]*[bcdfgjklmnpqrstvwxyz]/iu,
    /n(?:[*_\-]|[*-_])+[i1l!][*_\-]*[g96qɢԌ]?[ae3@4αаåâá][*_\-]*[bcdfgjklmnpqrstvwxyz]\b/iu,
    /n(?:[*_\-]|[*-_])+er\b(?!(?:\s|$)nier)/iu,
    /n(?:[*_\-]|[*-_])+a\b(?!(?:\s|$)nia)/iu
];
