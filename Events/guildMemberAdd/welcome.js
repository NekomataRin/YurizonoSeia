...
module.exports = async (client, member) => {
    ...
    const WelcomeEmbed = new EmbedBuilder()
        ...
        .setTitle(`${title}`)
        .setDescription(`### ${desc}\n\n▸ <:NagisaTea:1245235614274555914> Before you go: Make sure you’ve completed the onboarding by picking your roles and unlocking channels!\n▸ <:CastoriceButterfly:1360457482371072133> First, check out <#1201819711273451560> to understand what this server is all about.\n▸ <a:SeiaMuted:1336385867136241705> Second, read the rules at <#1095655832844242975>. Trust me, you don’t wanna get bonked by <@751225225047179324>. *(<:MokouFire:1193405518467833956> Hot takes: he's usually chill… unless you break the rules and he pissed off.)*\n▸ <:CirnoWhat:1150565251562078249> Third, got questions? Head to <#1210851339085676595> — it’s your go-to help desk.\n▸ <:mikalove:1254109761125875802> Lastly, don’t forget to say hi in <#1365043912074465361> and show your gratitude to everyone in the server!\n-# <:CastoriceSip:1360440195966570701> Castorice (@nekorin727), YurizonoSeia's Dad.`)
