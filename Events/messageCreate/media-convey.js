...
const facebookLinkRegex = /https?:\/\/(?:www\.|web\.|m\.)?facebook\.com\/(?!(?:share\/[vr]\/))(?:(?:[^\/\s]+\/videos\/(\d+))|reel\/(\d+)|watch\/\?v=(\d+)|fb\.watch\/[\w-]+|[^\/]+\/posts\/[\w-]+|permalink\.php\?story_fbid=\d+&id=\d+|story\.php\?story_fbid=\d+&id=\d+|groups\/\d+\/posts\/[\w-]+)(?:[/?&][^\s]*)?/gi
