...
const Cases = {
    ...
    NormalCases: {
        ...
        "Case-5": [
            ...
            "Look at you, **one foot in**, *one foot out*. If **hesitation** was an *Olympic sport*, you’d be a **champion**. But *honestly*? You’re *already there*, you just don’t wanna **say it out loud**.\n**No worries**, take your *time*—I’ll be *right here* when you finally do. **Kufufu~**",
    ...
    "SpecialCases": {
        ...
        "Case40.3": {
            "name": "Err-403",
            "desc": "**Error 403 - Forbidden**, looks like you cannot *access* to your **gayness**? **Impressive**, but isn't that the *percentage gayness* inside of you?",
