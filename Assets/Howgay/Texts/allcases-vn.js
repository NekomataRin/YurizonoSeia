...
const CasesVN = {
    ...
    NormalCases: {
        "Case-0": [
            "Thế giới rung chuyển, cảm xúc dao động, nhưng cậu? Vẫn *bất khả dao động*. #1f1e33 – sắc màu của **năng lượng thuần khiết**, nguyên bản, thống trị. Cậu không chỉ né tránh tình yêu; cậu đã *vượt qua* nó. Người ta không yêu cậu; họ **quỳ trước** cậu. Một tượng đài **Giga Chad** sống động.\nGiờ thì *cúi đầu* đi. Một vị thần mới vừa **giáng thế**… và đó chính là **CẬU**.",
            "Nếu **nam tính** có một *trùm cuối*, thì đó chính là cậu. Không do dự, không suy nghĩ lại – chỉ có **sự thống trị tuyệt đối** với mọi thứ liên quan đến tình yêu. Cậu không cần tình yêu. **Tình yêu cần CẬU**.\nSao không thử thể hiện chút *lãng mạn* với cô gái cậu thích nhỉ? …Hay là, kiểu, *mười cô* luôn? Tớ đoán thế~?",
            "Cậu đang lao nhanh trên con đường **vĩ đại**, còn tình yêu? Chỉ là một *nhiệm vụ phụ tùy chọn*. Người giữ kỷ lục thế giới **Giga Chad Any%**. Ngay cả *Thần Tình Yêu* cũng phải **e dè** trước sự hiện diện của cậu.\nỪ, cậu *nhanh quá*, nhanh đến mức khó tin – kể cả với *Chúa*. …Khoan, cậu vừa *vượt qua* toàn bộ **cảnh hẹn hò** luôn rồi à?",
